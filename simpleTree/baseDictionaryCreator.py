...
with open('dico', 'wb') as dictionary:
    ...
    dictNP.append(DictionaryRow("drole",1.0,None))
    dictNP.append(DictionaryRow("excellent",1.0,None))
    dictNP.append(DictionaryRow("intelligent",1.0,None))
    dictNP.append(DictionaryRow("malheureux",None,1.0))
    dictNP.append(DictionaryRow("mediocre",None,1.0))
    dictNP.append(DictionaryRow("vrai",1.0,None))
    dictNP.append(DictionaryRow("faux",None,1.0))
